...
@Service
public class TestQueryExecutorServiceImpl implements TestQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("TestWMQueryExecutor")
